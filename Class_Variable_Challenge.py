...
class Property:
    ...
    total_revenue = 0
    def __init__(self, type, location, price, sold):
        self.type = type
...
pro1 = Property("real estate", "Chicago", 120000, "available")
pro2 = Property("real estate", "British Columbia", 500000, "sold out")
pro3 = Property("real estate", "Manchester", 999000, "available")

class LuxuryProperty(Property):
        def __init__(self, type, location, price, sold, luxury_tax):
            super().__init__(type, location, price, sold)
            self.luxury_tax = luxury_tax
            self.price += self.price * luxury_tax
Lux1 = LuxuryProperty("real estate", "Alabama", 1200499, "available", 0.1)
Lux2 = LuxuryProperty("real estate", "Los Angeles", 5326488, "available", 0.15)
